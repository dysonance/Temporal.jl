...
@test X[i,i].values == hcat([data[i,i]])
@test Y[i,i].values == hcat([data[i,i]])
...
@test X[dates[i],i].values == hcat([data[i,i]])
@test Y[times[i],i].values == hcat([data[i,i]])
...
@test X[r,i].values == hcat(data[r,i])
@test Y[r,i].values == hcat(data[r,i])
...
@test X[dates[r],i].values == hcat(data[r,i])
@test Y[times[r],i].values == hcat(data[r,i])
...
@test X[a,i].values == hcat(data[r,i])
@test Y[a,i].values == hcat(data[r,i])
...
@test X[collect(dates[r]),i].values == hcat(data[r,i])
@test Y[collect(times[r]),i].values == hcat(data[r,i])
...
@test X[dsr,i].values == hcat(data[r,i])
@test Y[tsr,i].values == hcat(data[r,i])
