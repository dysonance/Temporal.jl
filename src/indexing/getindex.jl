...
getindex{R<:Int,V,T}(x::TS{V,T}, r::R) = x[[r]]
getindex{R<:Int,V,T}(x::TS{V,T}, r::R, ::Colon) = TS{V,T}(x.values[r,:], x.index[r], x.fields)
getindex{R<:Integer,V,T}(x::TS{V,T}, r::AbstractVector{R}) = TS{V,T}(x.values[r,:], x.index[r], x.fields)
getindex{R<:Integer,V,T}(x::TS{V,T}, r::AbstractVector{R}, ::Colon) = TS{V,T}(x.values[r,:], x.index[r], x.fields)

# int/bool column indexing
getindex{C<:Int}(x::TS, ::Colon, c::C) = TS(x.values[:,[c]], x.index, x.fields[c])
getindex{C<:Integer,V,T}(x::TS{V,T}, ::Colon, c::AbstractVector{C}) = TS{V,T}(x.values[:,c], x.index, x.fields[c])
...
getindex{C<:Int}(x::TS, r::TS{Bool}, c::C) = x[r.index[overlaps(r.index,x.index).*r.values],c]
...
getindex{V,T<:TimeType,C<:Int}(x::TS{V,T}, t::T, c::C) = x[x.index.==t,c]
...
getindex{V,T<:TimeType,C<:Int}(x::TS{V,T}, t::AbstractVector{T}, c::C) = x[overlaps(x.index,t),c]
...
getindex{R<:AbstractString,C<:Int}(x::TS, r::R, c::C) = x[dtidx(r, x.index), c]
